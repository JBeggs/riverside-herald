...
function VerifyEmailInner() {
  ...
  return (
    <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-xl border border-gray-200 text-center space-y-4">
      {!token ? (
        <>
...
export default function VerifyEmailPage() {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
      <Suspense
        fallback={<div className="bg-white p-8 rounded-xl text-text-muted shadow-xl border border-gray-200">Loading…</div>}
      >
        <VerifyEmailInner />
      </Suspense>
    </div>
